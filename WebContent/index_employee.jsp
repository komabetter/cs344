		...
		<div class="container">
			<div class="header">
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom active"><a href="index_employee.jsp">Home<i><img src="images/nav-but1.png" alt=""/></i></a></li>
						<li class="hvr-sweep-to-bottom"><a href="employee_selectAllOrder">Services<i><img src="images/nav-but3.png" alt=""/></i></a></li>
			...
			<div  id="top" class="callbacks_container">
				<ul class="rslides" id="slider3">
					<li>
						...
						<h2>Welcome to EMPLOYEE<span><%=em.getEmployeename() %> </span></h2>  
