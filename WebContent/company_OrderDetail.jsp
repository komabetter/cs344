		...
		<div class="container">
			<div class="header">
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom"><a type="button" value="Back" onclick="javascript:history.go(-1)">Home<i><img
...
%>
						...
						<h3 class="wow fadeInRight animated" data-wow-delay="0.4s"
							style="visibility: visible; -webkit-animation-delay: 0.4s;">ราคารวม
							:<%=total %></h3>
